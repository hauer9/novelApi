...
class Tag(models.Model):
    ...
    标签
    """
    name = models.CharField(max_length=100, verbose_name='标签', help_text='标签')
...
class Novel(models.Model):
    ...
    cover = models.URLField(null=True, blank=True, default='https://qiniu.tuscanyyy.top/cover.jpg', verbose_name='封面',
                            help_text='封面')
