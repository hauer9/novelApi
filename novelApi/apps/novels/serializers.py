...
from .models import Novel, Slider, Type, Chapter
...
class NovelsCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Novel
        fields = ['title', 'author', 'type', 'chapter']
...
class NovelsUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Novel
        fields = ['title', 'type', 'introduction', 'notice', 'cover', 'status']
